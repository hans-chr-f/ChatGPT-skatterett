...
Vi tester også om kvaliteten på svarene varierer med hvor mye kontekst (rettskilder) vi mater inn. Her har vi brukt fire forskjellige alternativer: 1) ingen kontekst, 2) bare lovetekst, 3) lovtekst + Skatte-ABC, 4) lovtekst pluss et utdrag fra en dom (EMI-dommen) som behandler samme type spørsmål.
...
- [Welshman – lov og 4 dommer](https://github.com/hans-chr-f/ChatGPT-skatterett/blob/main/welshman_lov_dommer.md)
